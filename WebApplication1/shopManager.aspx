<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="shopManager.aspx.cs" Inherits="WebApplication1.shopmanage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="right"style="text-align:center;margin-left:10px;">
        <h3 style="margin:10px 0px 0px 10px;"> 当前页面：商品管理</h3>
           <p style="text-align:right;margin-bottom:10px;">
           关键字：<asp:DropDownList ID="DropDownList1" runat="server">
                   <asp:ListItem>按商品名</asp:ListItem>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="1313px" Height="589px" OnRowEditing="GridView1_RowEditing" OnRowDeleting="GridView1_RowDeleting" DataSourceID="SqlDataSource1">
            <Columns>
                ...
                <asp:BoundField DataField="MV_img" HeaderText="商品图片" SortExpression="MV_img" />
         ...
         <br />
         <asp:Button ID="btntianjia" runat="server" CssClass="auto-style1" Height="33px" Text="添加" Width="107px" OnClick="btntianjia_Click" />
         </div>
</asp:Content>
